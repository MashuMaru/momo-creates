...
function Recent() {
    return <section id="recent" className="recent-section carousel slide" data-ride="carousel">
    <h1 className="recent-heading">RECENT WORK</h1>
    <ol className="carousel-indicators">
      <li data-target="#carouselExampleCaptions" data-slide-to="0" className="active active-indicator"></li>
